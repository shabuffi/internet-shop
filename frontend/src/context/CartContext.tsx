...
export interface CartItem {
  ...
  chestnyZnak?: boolean;
  // Остаток на складе на момент добавления — чтобы в корзине сравнить с количеством
  // и показать подсказку «заказываете больше, чем в наличии». undefined — остаток неизвестен.
  stock?: number;
}
