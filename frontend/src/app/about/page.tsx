    ...
    <div className="page">
      ...
      <div className="container section" style={{ maxWidth: 820 }}>
        <div style={{ fontSize: "var(--t-body-lg)", lineHeight: 1.7, color: "var(--charcoal)" }}>
          <p>
            <b style={{ color: "var(--ink)" }}>{name}</b> — оптовый поставщик хозтоваров, бытовой химии,
            товаров для дома, дачи и сада. Мы работаем с розничными магазинами, универмагами и небольшими
            торговыми точками: тысячи позиций со склада, удобный бланк заказа и быстрая отгрузка.
          </p>
          <p style={{ marginTop: "var(--s-4)" }}>
            Доставляем по Тверской, Московской, Смоленской и Новгородской областям. Постоянным клиентам —
            специальные цены и актуальный прайс по запросу.
          </p>
          <p style={{ marginTop: "var(--s-4)", fontSize: "var(--t-sm)", color: "var(--graphite)" }}>
            (Черновой текст — заменим на ваш, когда пришлёте.)
          </p>
        </div>
